...
--
-- Vært: 127.0.0.1
-- Genereringstid: 09. 06 2017 kl. 10:16:59
...
--
-- Struktur-dump for tabellen `category_editors`
--
...
--
-- Data dump for tabellen `category_editors`
--

INSERT INTO `category_editors` (`fk_users_id`, `fk_categories_id`) VALUES
(9, 3),
(9, 1),
(9, 12);
...
(5, 'Vestibulum commodo', '<p>Nunc sed lectus et eros consequat ullamcorper. Fusce at risus tempor magna sodales iaculis. Aliquam hendrerit sapien lectus, at rutrum lectus hendrerit ac. Nam vitae magna quis eros porta tristique. Vestibulum commodo, sapien vel pulvinar pellentesque, mi lorem pulvinar arcu, sed dictum ligula ipsum ac diam. Nam quis euismod nibh. Duis justo lacus, faucibus eget pellentesque sed, dignissim sed ligula. Nunc eleifend cursus dui, vitae mollis metus fringilla sed. Nunc vitae orci non dui ornare convallis. Phasellus iaculis id ligula non pretium. Morbi quis sagittis urna, id sodales mi. Suspendisse sed metus non nisi volutpat iaculis vitae a neque. Donec lacinia porta interdum. Fusce sodales elit eu rhoncus fringilla. In venenatis massa id sem sagittis, nec molestie neque lobortis.</p>\r\n', '2013-02-02 20:08:37', 2, 1),
...
(32, 'Maecenas interdum', '<p>Morbi interdum adipiscing iaculis. Phasellus eu felis et justo viverra dapibus. Maecenas interdum, massa eu malesuada fringilla, erat elit consequat diam, bibendum rhoncus arcu sapien sed dolor.</p>\r\n', '2013-09-17 14:30:51', 2, 3),
...
CREATE TABLE `users` (
  ...
  `user_password` varchar(72) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'Albert Andersen', '$2y$10$dwwGzVWmzhLnODRNQlh8SeNw17P8Y/cZ9Ku82HIk1NbC4J.4RQspy', 'aa@cmk-dynamisk-web.dk', 3),
(2, 'Benny Boss', '$2y$10$yVIK3wPHiNx2KZ9wpoErce6edtAB3eM0Rg1tlvfLV8gCSRvhfgW5e', 'bb@cmk-dynamisk-web.dk', 2),
(9, 'Carl Carstensen', '$2y$10$in0WKgMzm9o8Vi.IeUBsRO9zpVqCTgx/2VYUGjv10ReyEi2XOUlsK', 'cc@cmk-dynamisk-web.dk', 3),
(10, 'Dan Donaldson', '$2y$10$xvB2KA.QkByQJLwCauWQXOe4nv5G4QDUbfyk8dehgoqkNHTXtkUmi', 'dd@cmk-dynamisk-web.dk', 3),
(11, 'Egon Erikson', '$2y$10$9SO.FM.AS/8Ovlj/6R.Bwu/prSnIed9ep.Rk0e78ONNb0fNDouDZS', 'ee@cmk-dynamisk-web.dk', 2),
(12, 'Finn Fransen', '$2y$10$wrmoqM0eAZisEMBWYDSrIu1zXnj39U4DKlpYOzkX37bdax.vd40IO', 'ff@cmk-dynamisk-web.dk', 3),
(13, 'Jens Jensen', '$2y$10$Ar/1BTS1yHAg0riBWjvV5eT.tw/hJSPGHBGsMPyA.PJ2oLfMnaRn2', 'jj@cmk-dynamisk-web.dk', 1),
(15, 'Gert Gantt', '$2y$10$hOhh1ISVcprVWgrrgeDgW.dRkhrVv0WZ4ig44OytGqnhtrEFgVFMO', 'gg@cmk-dynamisk-web.dk', 1);
...
--
-- Indeks for tabel `category_editors`
--
...
--
-- Begrænsninger for tabel `category_editors`
--
ALTER TABLE `category_editors`
